...
//        request.setMWSAuthToken(mwsAuthToken);
        ...
        try {
        	createdAfter = DatatypeFactory.newInstance().newXMLGregorianCalendar(2016, 5, 18, 18, 30, 59, 999, 0);
        ...
        try {
			createdBefore = DatatypeFactory.newInstance().newXMLGregorianCalendar(2016, 5, 20, 18, 30, 59, 999, 0);
		} catch (DatatypeConfigurationException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}  
